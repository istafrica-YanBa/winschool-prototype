...
import { BookOpen, Calendar, Clock, Search, BarChart3, User, AlertCircle, CheckCircle, History, Plus } from 'lucide-vue-next'
  ...
  <div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
      ...
      <div v-if="activeTab === 'history'" class="p-6">
        ...
        <div v-if="myReservations.length > 0" class="mb-8">
          <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">My Reservations</h3>
          <div class="bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
            <div class="divide-y divide-yellow-200 dark:divide-yellow-800">
              ...
              >
                <div>
                  <h4 class="font-medium text-gray-900 dark:text-white">{{ reservation.title }}</h4>
                  <p class="text-sm text-gray-600 dark:text-gray-400">by {{ reservation.author }}</p>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    Requested: {{ formatDate(reservation.requestDate) }} | 
                    Preferred: {{ formatDate(reservation.preferredDate) }}
                  </p>
                </div>
                <span :class="[getStatusColor(reservation.status), 'px-2 py-1 rounded-full text-xs font-medium bg-white dark:bg-gray-800']">
